...
mgd.MIN_GAP = 300; // minimum wait between missile fires in 1/1000 of a second
mgd.MAX_MISSILES = 4;
mgd.startspeed = 1.1;
mgd.missile_speed = -350;
mgd.bombspeed = 220;
...
mgd.gamereset = function(){
  ...
  mgd.score = 0;
  mgd.basebombinterval = 120;
  mgd.bombinterval = mgd.basebombinterval;
}
...
mgd.levelreset = function(){
  ...
  mgd.basebombinterrval = mgd.basebombinterval * .96;
  mgd.bombinterval = mgd.basebombinterrval;
}
